...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            Vendedor <asp:TextBox ID="TextBox1" runat="server" required="true"></asp:TextBox>
            <br />
            Fecha 
            <asp:TextBox ID="TextBox2" runat="server" TextMode="Date" required="true"></asp:TextBox>
            <br />
             Monto
            <asp:TextBox ID="TextBox3" runat="server" value="$" required="true"></asp:TextBox>
            <br />
            Detalle de venta
            <asp:TextBox ID="TextBox4" runat="server" Height="75px" TextMode="MultiLine" Width="304px"></asp:TextBox>
            <br />
